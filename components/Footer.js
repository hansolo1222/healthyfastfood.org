...
import { Subscribe } from "./Subscribe";
  const navigation = {
    ...
    restaurants: [
      ...
      { name: "Taco Bell", href: '/taco-bell' },
      { name: "Wendy's", href: '/wendys' },
      { name: "Dunkin Donuts", href: '/dunkin-donuts' },
      { name: "Burger King", href: '/burger-king' },
      { name: "Subway", href: '/subway' },
      { name: "Domino's Pizza", href: '/dominos-pizza' },
    ...
    categories: [
      ...
      { name: "Wings", href: '/category/wings' },
      { name: "Burritos", href: '/category/burritos' },
      { name: "Tacos", href: '/category/tacos' },
      { name: "Breakfast Meals", href: '/category/breakfast' },
    ...
    return (
      <footer className="bg-stone-100" aria-labelledby="footer-heading">
        ...
        <div className="max-w-8xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-12">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="grid grid-cols-2 gap-8 xl:col-span-2">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                ...
                {/* <div className="mt-12 md:mt-0">
                  <h3 className="text-sm font-semibold text-stone-600 tracking-wider uppercase">HealthyFastFood</h3>
                  <ul role="list" className="mt-3 space-y-3">
          ...
          <div className="mt-8 border-t border-stone-300 pt-8 md:flex md:items-center md:justify-between">
            <div className="flex space-x-6 md:order-2">
              {navigation.social.map((item) => (
                <a key={item.name} href={item.href} className="text-stone-600 hover:text-stone-500">
            ...
            <p className="mt-8 text-base text-stone-400 md:mt-0 md:order-1">
              &copy; 2022 HealthyFastFood. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
